...
// The wordmark path's original fill (#fff) is illegible on the paper/cream
// credential cards it's used on, so it's recolored to currentColor here —
// the orange "smile" swoosh keeps its brand color as given.
